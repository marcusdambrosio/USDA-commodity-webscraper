...
def TOMATOES(tomatoes):
    ...
    # for row in tomatMaster.iterrows():
    #     i, row = row
    #     if math.isnan(row['High Price']):
    #         rowCount = 1
    #         if i==0:
    #             continue
    #         if tomatMaster.loc[i-1,['Crop', 'Variety', 'Grade', 'Type']].all() != tomatMaster.loc[i,['Crop', 'Variety', 'Grade', 'Type']].all():
    #             while rowCount < 7:
    #                 if i + rowCount + 1 > len(tomatMaster):
    #                     break
    #                 if math.isnan(tomatMaster.loc[i+rowCount, 'High Price']):
    #                     rowCount += 1
    #                 else:
    #                     for n in range(rowCount):
    #                         tomatMaster.loc[i+n, ['High Price','Low Price', 'Average']] = tomatMaster.loc[i+rowCount, ['High Price','Low Price', 'Average']]
    #                     break
    #         else:
    #             while rowCount < 8:
    #                 if math.isnan(tomatMaster.loc[i-rowCount, 'High Price']):
...
def ALMONDS(almonds):
    # for col in almonds.columns:
    #     print(col, '\n\n')
    #     print(almonds[col].unique(), '\n\n')
    # sys.exit()
...
def GRAPES(grapes):
    # for col in grapes.columns:
    #     print(col, '\n\n')
    #     print(grapes[col].unique(), '\n\n')
    # sys.exit()
...
def PISTACHIOS(pistachios):
    # for col in pistachios.columns:
    #     print(col, '\n\n')
    #     print(pistachios[col].unique(), '\n\n')
    # sys.exit()
...
def STRAWBERRIES(strawberries):
    # for col in strawberries.columns:
    #     print(col, '\n\n')
    #     print(strawberries[col].unique(), '\n\n')
    # sys.exit()
