        ...
        for state in dropdown_elements.states:
            ...
            for crop in dropdown_elements.focusedCrops:
                ...
                driver.find_element_by_id('Add').click()
                            ...
                            # commodityDropdown.select_by_visible_text(dropdown_elements.crops[0])
                            # #add placeholder commodity
                            # driver.find_element_by_id('Add').click()
                            # commodityDropdown2 = Select(driver.find_element_by_id('commAbr'))
                            # commodityDropdown2.select_by_visible_text(dropdown_elements.crops[0])
                            # #remove placeholder commodity
                            # driver.find_element_by_id('Remove').click()
                            # commodityDropdown.select_by_visible_text('ALL')
                            # #add all crops
                            # driver.find_element_by_id('Add').click()
            # #open up date boxes
